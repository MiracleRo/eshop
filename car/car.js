(function () {
	...
	adress.onmouseover = function(){
			first_icon.src='car_images/top_down.png'
	}
	adress.onmouseout =function(){
			first_icon.src='car_images/top_up.png'
	}
	//收货地址改变图片函数
	...
	personalcenter.onmouseover = function(){
			personal_down.src='car_images/top_down.png'
	}
	personalcenter.onmouseout =function(){
			personal_down.src='car_images/top_up.png'
	}
	//用户导航栏改变图片函数
	...
	allgoods.onmouseover = function(){
			allicon.src='car_images/top_down.png'
	}
