(function () {
	...
	adress.onmouseover = function(){
			first_icon.src='pay_images/top_down.png'
	}
	adress.onmouseout =function(){
			first_icon.src='pay_images/top_up.png'
	}
	//收货地址改变图片函数
	...
	personalcenter.onmouseover = function(){
			personal_down.src='pay_images/top_down.png'
	}
	personalcenter.onmouseout =function(){
			personal_down.src='pay_images/top_up.png'
	}
	//用户导航栏改变图片函数
	...
	allgoods.onmouseover = function(){
			allicon.src='pay_images/top_down.png'
	}
	allgoods.onmouseout =function(){
			allicon.src='pay_images/top_up.png'
	}
	//所有分类导航栏改变图片函数
	// function banner(){
